    ...
    stage('Promoting release v5.1') {
      ...
      stages {
        stage('Generating release') {
          steps {
            sh 'docker tag registry.sonata-nfv.eu:5000/tng-slice-mngr:latest registry.sonata-nfv.eu:5000/tng-slice-mngr:v5.1'
            sh 'docker tag registry.sonata-nfv.eu:5000/tng-slice-mngr:latest sonatanfv/tng-slice-mngr:v5.1'
            sh 'docker push registry.sonata-nfv.eu:5000/tng-slice-mngr:v5.1'
            sh 'docker push sonatanfv/tng-slice-mngr:v5.1'
          }
        }
      }
    }
